...
id: e0d5bd37-f020-4235-ad81-c977baaeb24f
DateApproved: 7/6/2023

# Summarize the whole topic in less than 300 characters for SEO purpose
description: Explain how to extend Visual Studio Code's workbench area with custom UI components
sidebar_position: 4
---

# 延伸工作台

"Workbench" 指的是整个Visual Studio Code UI，它包含以下UI组件:
...
VS Code提供了各种AP，允许你将自己的组件添加到工作台。例如，在下图中:
