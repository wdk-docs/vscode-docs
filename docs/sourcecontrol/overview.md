...
Area: sourcecontrol
title: 概述
id: 7E22CCC0-2AB8-4729-A4C9-BE2B16853820
PageTitle: 在Visual Studio Code中使用Git进行源代码控制
DateApproved: 7/6/2023
description: Visual Studio Code源代码控制管理与集成的Git支持。
sidebar_position: 1
---

# 在VS Code中使用Git源代码管理

Visual Studio Code集成了源代码控制管理(SCM)，并包括开箱即用的[Git](https://git-scm.com/)支持。
许多其他的源代码控制提供程序可以通过VS Code市场上的[扩展](/docs/editor/extension-marketplace.md)获得。
...
### vscode作为Git的difftool和mergetool
...
![市场中的SCM供应商类别](images/overview/scm-provider-category.png)

## 下一个步骤

- [介绍视频- Git版本控制](/docs/introvideos/versioncontrol.md) - 一个提供VS Code Git支持概述的介绍性视频。
- [基本编辑](/docs/editor/codebasics.md) - 了解强大的VS Code编辑器。
- [代码导航](/docs/editor/editingevolved.md) - 快速浏览源代码。
- [调试](/docs/editor/debugging.md) - 这就是VS Code真正闪耀的地方
- [任务](/docs/editor/tasks.md) - 使用Gulp, Grunt和Jake运行任务。显示错误和警告
- [源代码控制API](/api/extension-guides/scm-provider.md) - 如果你想将另一个源代码控制提供程序集成到VS Code中，请参阅我们的源代码控制API。
