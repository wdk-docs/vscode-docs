...
Area: setup
title: macOS
id: EEADB50A-F5E3-41E9-89DA-35F165196691
PageTitle: Running Visual Studio Code on macOS
DateApproved: 7/6/2023
description: Get Visual Studio Code up and running on Mac (macOS).
sidebar_position: 3
---
...
升级到macOS Mojave版本后，您可能会看到这样的对话框 "Visual Studio Code would like to access your {calendar/contacts/photos}." This is due to the new privacy protections in Mojave and is not specific to VS Code. The same dialogs may be displayed when running other applications as well. The dialog is shown once for each type of personal data and it is fine to choose **Don't Allow** since VS Code does not need access to those folders.
...
### 为什么我看到 "Visual Studio Code would like access to your calendar."
...
是的，VS Code支持macOS Arm64构建，可以在带有苹果硅片组的mac上运行。您可以安装通用构建，其中包括英特尔和苹果芯片构建，或者特定于平台的构建之一。
